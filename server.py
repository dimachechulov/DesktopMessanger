    ...
    while True:
        ...
        if r_clients:
            for r_sock in r_clients:
                try:
                    parse_client_msg(receive_message(r_sock), all_messages,all_messages_in_router, r_sock, all_clients, all_names)
        ...
        for msg in all_messages_in_router:
            try:
